...
class HomeSongAlbumsScreens extends StatelessWidget {
  final MainController? con;
  final List<HomelistPlayedSongData>? albumdata;

  const HomeSongAlbumsScreens({Key? key, this.albumdata, this.con})
      : super(key: key);
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  var data = {
                    ...
                    "song_id": albumdata![index].songId.toString(),
                  };
                  print(albumdata![index].albumId);
                  if (albumdata![index]
                          .albumId
                          .toString()
                          .toLowerCase()
